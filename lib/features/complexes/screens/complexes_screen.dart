...
/// Вкладка «Шахматка»: список объектов, из каждого — переход в сетку блоков.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: [
        const AppHeader(
          title: 'Объекты',
          subtitle: 'Шахматка квартир по блокам',
            ...
            data: (list) => ListView(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    'Если коллега взял квартиру в работу, вы увидите это здесь '
                    'без звонка в офис.',
                    style: TextStyle(
                      fontSize: 11.5,
                      height: 1.5,
