...
INSERT INTO expected VALUES
  ...
  ('organizations','grace_days','NO',true,'integer'),
  ('organizations','id','NO',true,'uuid'),
  ('organizations','is_blocked','NO',true,'boolean'),
  ('organizations','name','NO',false,'text'),
  ('organizations','plan_kind','NO',true,'text'),
  ('organizations','plan_until','NO',true,'timestamp with time zone'),
  ...
  ('subscriptions','created_at','NO',true,'timestamp with time zone'),
  ('subscriptions','created_by','YES',false,'uuid'),
  ('subscriptions','ends_at','NO',false,'timestamp with time zone'),
  ('subscriptions','id','NO',true,'uuid'),
  ('subscriptions','kind','NO',false,'text'),
  ('subscriptions','note','YES',false,'text'),
  ('subscriptions','org_id','NO',false,'uuid'),
  ('subscriptions','starts_at','NO',true,'timestamp with time zone'),
...
INSERT INTO expected_idx VALUES
  ...
  ('subscriptions_org_idx','subscriptions'),
  ('subscriptions_pkey','subscriptions'),
...
INSERT INTO expected_con VALUES
  ...
  ('files_org_fk','files'),
  ('organizations_plan_kind_check','organizations'),
  ...
  ('roles_code_check','roles'),
  ('settings_org_fk','settings'),
  ('settings_pkey','settings'),
  ('subscriptions_org_fk','subscriptions'),
  ('users_id_org_uniq','users'),
  ('users_org_fk','users');
